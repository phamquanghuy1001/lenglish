...
public class LessonLogResource {
    ...
    @Timed
    public ResponseEntity<LessonLogDTO> createLessonLog(@Valid @RequestBody LessonLogDTO lessonLogDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<LessonLogDTO> updateLessonLog(@Valid @RequestBody LessonLogDTO lessonLogDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<List<LessonLogDTO>> getAllLessonLogsByLesson(@ApiParam Pageable pageable, @PathVariable Long id) {
        log.debug("REST request to get a page of LessonLogs");
