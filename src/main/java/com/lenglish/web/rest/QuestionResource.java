...
public class QuestionResource {
    ...
    // new code
    /**
     * GET  /questions_by_lesson : get all the questions by lesson.
     *
     * @param pageable the pagination information
     * @return the ResponseEntity with status 200 (OK) and the list of questions in body
     */
    ...
    @Timed
    public ResponseEntity<List<QuestionDTO>> getAllQuestions(@ApiParam Pageable pageable, @PathVariable Long id) {
